			...
			<div className="flex flex-col container items-center gap-10 py-10 md:flex-row">
				<div className="w-full text-center md:text-left md:w-2/4 md:justify-center">
					...
					<div className="text-gray-300 mt-6">
						Создаваю красивые, удобные для пользователей интерфейсы сайтов. Быстро
						обучаюсь и ориентируюсь в чужом коде. Имею опыт верстки и разработки функционала для
						SPA-приложений на React. Постоянно изучаю что-то новое и не стою на месте. 
					</div>
					<div className="mt-10">
						<a
